 ...
 *
 * Extracted from Slack thread buffering so any ingress (AgentMail, GitHub/GitLab
 * issue comments, Linear comments — NOT schedule/workflow) can coalesce rapid
 * follow-up inputs into a single task.
 *
