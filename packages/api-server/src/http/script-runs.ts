...
import { getAppUrl } from "@swarm/core-utils/constants";
import {
...
import { executeRawLlm } from "@swarm/workflows/executors/raw-llm";
import { z } from "zod";
...
const rawLlmBodySchema = z.object({
  prompt: z.string(),
