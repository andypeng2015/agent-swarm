...
--
-- Seed:
--   * pricing rows derived from `CODEX_MODEL_PRICING` (packages/harness/src/codex-models.ts:97-119),
...
-- Seed Codex price book. Mirrors CODEX_MODEL_PRICING (packages/harness/src/codex-models.ts).
