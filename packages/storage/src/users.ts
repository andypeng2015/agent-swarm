 ...
 * `packages/harness/`, `packages/prompt-templates/`, `src/cli.tsx`) do not
 ...
 *   * Q19  — full event-type CHECK enum (mirrored in `@swarm/types` + migration 064)
 ...
 * will pass the raw key through `getApiKey()` from `@swarm/core-utils/api-key`
