 ...
 *
 * Skill templates live under `@swarm/swarm-templates/skills/<name>`. Entries with
...
import artifactsConfig from "@swarm/swarm-templates/skills/artifacts/config.json" with {
  type: "text",
};
import artifactsContent from "@swarm/swarm-templates/skills/artifacts/content.md" with {
  type: "text",
};
import attioInteractionConfig from "@swarm/swarm-templates/skills/attio-interaction/config.json" with {
  type: "text",
};
import attioInteractionContent from "@swarm/swarm-templates/skills/attio-interaction/content.md" with {
  type: "text",
};
import kvStorageConfig from "@swarm/swarm-templates/skills/kv-storage/config.json" with {
  type: "text",
};
import kvStorageContent from "@swarm/swarm-templates/skills/kv-storage/content.md" with {
  type: "text",
};
import pagesConfig from "@swarm/swarm-templates/skills/pages/config.json" with { type: "text" };
import pagesContent from "@swarm/swarm-templates/skills/pages/content.md" with { type: "text" };
import scriptWorkflowsConfig from "@swarm/swarm-templates/skills/script-workflows/config.json" with {
  type: "text",
};
import scriptWorkflowsContent from "@swarm/swarm-templates/skills/script-workflows/content.md" with {
  type: "text",
};
import swarmScriptsConfig from "@swarm/swarm-templates/skills/swarm-scripts/config.json" with {
  type: "text",
};
import swarmScriptsContent from "@swarm/swarm-templates/skills/swarm-scripts/content.md" with {
  type: "text",
};
import tasteMinimalistSkillConfig from "@swarm/swarm-templates/skills/taste-minimalist-skill/config.json" with {
  type: "text",
};
import tasteMinimalistSkillContent from "@swarm/swarm-templates/skills/taste-minimalist-skill/content.md" with {
  type: "text",
};
import workflowIterateConfig from "@swarm/swarm-templates/skills/workflow-iterate/config.json" with {
  type: "text",
};
import workflowIterateContent from "@swarm/swarm-templates/skills/workflow-iterate/content.md" with {
  type: "text",
};
import workflowStructuredOutputConfig from "@swarm/swarm-templates/skills/workflow-structured-output/config.json" with {
  type: "text",
};
import workflowStructuredOutputContent from "@swarm/swarm-templates/skills/workflow-structured-output/content.md" with {
  type: "text",
};
