 ...
 *
 * This module is imported from worker-side hook/provider paths (the session
 * summary piggyback path), so it MUST NOT touch SQLite or the API-owned
 * database layer. The DB-boundary check enforces this.
 *
