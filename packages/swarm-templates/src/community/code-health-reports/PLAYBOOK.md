...
The community template lives in `packages/swarm-templates/src/community/code-health-reports/` and contains:
...
cp packages/swarm-templates/src/community/code-health-reports/run.sh /workspace/code-maat/
cp packages/swarm-templates/src/community/code-health-reports/report.mjs /workspace/code-maat/
cp packages/swarm-templates/src/community/code-health-reports/lead-prompt.md /workspace/code-maat/
...
2. Install the template.
   ...
   Copy `run.sh`, `report.mjs`, and `lead-prompt.md` from `packages/swarm-templates/src/community/code-health-reports/` into `/workspace/code-maat`, then make the runner executable.
