...
import { checkToolLoop } from "@swarm/core-utils/tool-loop-detection";
...
// `@swarm/core-utils/context-window`, which resolves shortnames + dated full ids
 ...
 * a fully-qualified `https://...` URL — see `@swarm/types` and
