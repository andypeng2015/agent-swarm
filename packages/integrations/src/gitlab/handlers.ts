 ...
 *
 * Mirrors the GitHub handlers pattern:
...
import { failTask, findTaskByVcs, getAllAgents, incrKv, upsertKv } from "@swarm/storage/db";
import { findOrCreateUserByEmail, findUserByExternalId, linkIdentity } from "@swarm/storage/users";
import { gitlabContextKey } from "@swarm/workflows/tasks/context-key";
