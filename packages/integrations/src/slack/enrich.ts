 ...
 * previously lived in the Slack handlers module (Q17.E):
 *
 ...
 *
 * Both helpers are server-side integration code, so they may import storage.
 */

import type { WebClient } from "@slack/web-api";
import { getKv, upsertKv } from "@swarm/storage/db";
import { recordUnmappedIdentity } from "@swarm/storage/unmapped-identities";
import {
