...
describe("config catalog invariants (v6 §0.14 / §10)", () => {
  test("catalog has exactly 80 entries (12 legacy + 14 round-6 + pi-gemini-pro + 10 round-8 OSS refresh + 17 round-9 expansion + 12 round-10 leaderboard additions + 14 round-11 June 2026 refresh)", () => {
    expect(configs.length).toBe(80);
  });
