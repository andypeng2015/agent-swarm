...
import bootTriageSrc from "./catalog/boot-triage.ts?raw" with { type: "text" };
import catalogReportSrc from "./catalog/catalog-report.ts?raw" with { type: "text" };
import compoundInsightsSrc from "./catalog/compound-insights.ts?raw" with { type: "text" };
import dateResolveSrc from "./catalog/date-resolve.ts?raw" with { type: "text" };
import fetchReadableSrc from "./catalog/fetch-readable.ts?raw" with { type: "text" };
import ghPrSnapshotSrc from "./catalog/gh-pr-snapshot.ts?raw" with { type: "text" };
import groupCountSrc from "./catalog/group-count.ts?raw" with { type: "text" };
import jsonQuerySrc from "./catalog/json-query.ts?raw" with { type: "text" };
import linearIssueSrc from "./catalog/linear-issue.ts?raw" with { type: "text" };
import memoryDedupCheckSrc from "./catalog/memory-dedup-check.ts?raw" with { type: "text" };
import memoryEvalSrc from "./catalog/memory-eval.ts?raw" with { type: "text" };
import opsCatalogAuditSrc from "./catalog/ops-catalog-audit.ts?raw" with { type: "text" };
import scheduleHealthSrc from "./catalog/schedule-health.ts?raw" with { type: "text" };
import slackThreadFlattenSrc from "./catalog/slack-thread-flatten.ts?raw" with { type: "text" };
import smartRecallSrc from "./catalog/smart-recall.ts?raw" with { type: "text" };
import taskContextGatheringSrc from "./catalog/task-context-gathering.ts?raw" with { type: "text" };
import taskFailureAuditSrc from "./catalog/task-failure-audit.ts?raw" with { type: "text" };
import textDiffSrc from "./catalog/text-diff.ts?raw" with { type: "text" };
import toolUsageSrc from "./catalog/tool-usage.ts?raw" with { type: "text" };
