...
export interface SwarmSdk {
  tasks_create(args: Record<string, unknown>): Promise<unknown>;
  tasks_list(args?: Record<string, unknown>): Promise<unknown>;
  tasks_get(args: { id: string }): Promise<unknown>;
  memory_search(args: { query: string; limit?: number }): Promise<unknown>;
  memory_list(args?: Record<string, unknown>): Promise<unknown>;
  memory_get(args: { id: string }): Promise<unknown>;
  events_create(args: Record<string, unknown>): Promise<unknown>;
  events_list(args?: Record<string, unknown>): Promise<unknown>;
  kv_get(args: { key: string; namespace?: string }): Promise<unknown>;
  kv_set(args: { key: string; value: unknown; namespace?: string }): Promise<unknown>;
  kv_del(args: { key: string; namespace?: string }): Promise<unknown>;
  agents_list(args?: Record<string, unknown>): Promise<unknown>;
  agents_get(args: { id: string }): Promise<unknown>;
}
