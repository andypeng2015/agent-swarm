...
import { SCRIPT_DELETE_DESCRIPTION } from "@swarm/mcp-tool/script-delete";
import { SCRIPT_QUERY_TYPES_DESCRIPTION } from "@swarm/mcp-tool/script-query-types";
import { SCRIPT_RUN_DESCRIPTION } from "@swarm/mcp-tool/script-run";
import { SCRIPT_SEARCH_DESCRIPTION } from "@swarm/mcp-tool/script-search";
import { SCRIPT_UPSERT_DESCRIPTION } from "@swarm/mcp-tool/script-upsert";
