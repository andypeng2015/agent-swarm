...
const UNGATED_TOOL_FILES: Record<string, string> = {
  ...
  "src/tools/swarm-config/delete-config.ts": PIN_REASON,
  "src/tools/swarm-config/get-config.ts": PIN_REASON,
  "src/tools/swarm-config/list-config.ts": PIN_REASON,
...
const ROUTE_RBAC_BACKLOG: Record<string, string> = {
  ...
  "DELETE /api/config/{id}": BACKLOG_REASON,
