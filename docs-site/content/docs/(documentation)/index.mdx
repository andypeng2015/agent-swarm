---
title: Overview
description: Deploy and orchestrate autonomous AI coding agents that coordinate as a team — lead delegates tasks, workers ship in Docker, memory compounds across sessions. Slack, GitHub, Linear, and x402 payments included.
---
...
_Last updated: June 23, 2026 — v1.102.0_
