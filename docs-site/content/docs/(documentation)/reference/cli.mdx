---
title: CLI Reference
description: Complete CLI reference for managing agents, tasks, and swarm configuration from the terminal — install via bunx or npx, manage worktrees, run agent commands, and configure your swarm without the dashboard UI
---
...
The React-based monitoring dashboard is in the `apps/ui/` directory:
