...
<JsonLd
  data={{
    ...
    step: [
      ...
      { "@type": "HowToStep", name: "Install the community template", text: "Copy run.sh, report.mjs, and lead-prompt.md from packages/swarm-templates/src/community/code-health-reports into a workspace outside the target repository." },
...
- **[`packages/swarm-templates/src/community/code-health-reports`](https://github.com/desplega-ai/agent-swarm/tree/main/packages/swarm-templates/src/community/code-health-reports)** — the reusable package with:
