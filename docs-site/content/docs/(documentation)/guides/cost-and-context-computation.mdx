...
The UI path `apps/ui/src/lib/modelsdev-cache.json` is still a symlink to the backend snapshot. The model picker keeps using that committed file for names, labels, and context windows until a separate runtime catalog endpoint exists.
...
Operator reference: [`packages/harness/src/pricing-sources.md`](https://github.com/desplega-ai/agent-swarm/blob/main/packages/harness/src/pricing-sources.md).
...
- [`packages/harness/src/pricing-sources.md`](https://github.com/desplega-ai/agent-swarm/blob/main/packages/harness/src/pricing-sources.md) — operator workflow
