...
For host sizing and worker-role budgeting guidance, see the docs-site [Performance & Resource Sizing](https://docs.agent-swarm.dev/docs/guides/performance-resource-sizing) guide.
