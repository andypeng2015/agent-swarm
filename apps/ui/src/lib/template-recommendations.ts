 ...
 * `packages/swarm-templates/src/official/<id>/config.json`; the unit test in
 ...
 * record in `packages/swarm-templates/src/official/<id>/config.json` (enforced by unit test).
 */
