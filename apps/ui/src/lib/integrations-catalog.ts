 ...
 * - `'template'`: checked in under
 *   `packages/swarm-templates/src/skills/<name>/SKILL.md` in the agent-swarm repo.
 *   Installable via `skill-install-remote` using the
    ...
    recommendedSkills: [
      {
        ...
        templatePath: "packages/swarm-templates/src/skills/kapso-whatsapp",
        roles: ["lead", "worker"],
        reason:
    ...
    recommendedSkills: [
      {
        ...
        source: "template",
        templateRepo: "desplega-ai/agent-swarm",
        templatePath: "packages/swarm-templates/src/skills/attio-interaction",
        roles: ["lead", "worker"],
        reason:
    ...
    recommendedSkills: [
      {
        ...
        source: "template",
        templateRepo: "desplega-ai/agent-swarm",
        templatePath: "packages/swarm-templates/src/skills/agentmail-sending",
        roles: ["lead"],
        reason:
