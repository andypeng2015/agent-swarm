...
import { getApiKey, setApiKey } from "@swarm/core-utils/api-key";
...
if (args.showHelp || args.command === "help" || args.command === undefined) {
  ...
  const { runScriptsCommand } = await import("./commands/scripts");
  await runScriptsCommand(scriptsArgs, { apiKey: args.key });
