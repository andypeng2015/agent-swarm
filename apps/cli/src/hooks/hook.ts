...
import { checkToolLoop, clearToolHistory } from "@swarm/core-utils/tool-loop-detection";
 ...
 * `summarizeSessionForPi` pattern in `packages/harness/src/pi-mono-extension.ts`.
 */
 ...
 *   3. Call `runSummarize` from `@swarm/ai-llm` — picks credentials
