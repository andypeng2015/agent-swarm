 ...
 *     packages/harness/src/claude-adapter.ts:800-811.
 ...
 *     `web_search` (packages/harness/src/codex-adapter.ts:644-653,712-763). Error =
 ...
 *     See packages/harness/src/opencode-adapter.ts:449-489.
 */
