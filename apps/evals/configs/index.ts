...
export const configs: HarnessConfig[] = [
  ...
  // packages/ai-pricing/src/modelsdev-cache.json openrouter section with open_weights: true.
  ...
  // Every slug verified against packages/ai-pricing/src/modelsdev-cache.json openrouter section
  // with tool_call: true.
  {
    id: "pi-minimax-m3",
  ...
  // the catalog. Every slug verified against packages/ai-pricing/src/modelsdev-cache.json
