...
### Changed
- **Documentation was refreshed for task attachments and worker-image deployment defaults** (#907) — the repo and docs site now call out inline attachment previews, the worker-side raw attachment download route, and the current pinned harness versions in deployment guidance.
